				...
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
					...
					<div className='flex-1 relative'>
						<div className='relative'>
							...
							<div
								className='flex items-center gap-4 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4  h-24 border-2 border-solid border-slate-600 rounded-xl px-4 py-2'
							>
